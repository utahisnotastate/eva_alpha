...
const API_URL = 'https://clinicaltables.nlm.nih.gov/api/rxterms/v3/search?terms=arava&ef=STRENGTHS_AND_FORMS'
...
export default class MedicationAndDosageSearch extends Component {
    ...
    onSuggestionsFetchRequested = ({ value }) => {
        fetch(`https://clinicaltables.nlm.nih.gov/api/rxterms/v3/search?terms=${value}&ef=RXCIUS`)
    ...
    render() {
        const {
            medicationsuggestions, medicationdosages, medicationname
        } = this.state;

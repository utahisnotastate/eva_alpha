		...
		<Card>
			<CardContent>
				<Grid container direction={`row`}>
						...
						<Grid container spacing={3} direction={`column`}>
							...
							<Grid item>
								<Grid container>
									...
									<Grid item xs={2}>
										<select
											name={`complaints[${index}].onset_unit`}
											ref={register}>
							...
							<Grid item>
								...
								<select
									name={`complaints[${index}].location`}
									ref={register}>
									<option value={null}>
										Select Location
									</option>
									...
									<option value="upper_extremity">
										Upper Extremity
									</option>
									<option value="lower_extremity">
										Lower Extermity
									</option>
							...
							<Grid item>
								<TextField
									...
									defaultValue={
										complaint.patient_belief_caused_by
									}
								/>
							</Grid>
							<Grid item>
								<TextField
									...
									fullWidth
									inputRef={register()}
									name={`complaints[${index}].patients_guess`}
									label={`What is patient's guess?`}
									defaultValue={complaint.patients_guess}
								/>
							</Grid>
							<Grid item>
								<Typography>
									Other comments made by patient not indicated
									above:
								</Typography>
							</Grid>
							<Grid item>
					...
					<Grid item xs={2}>
						<Button onClick={() => console.log('Delete this!')}>
							X
						</Button>
					</Grid>
				</Grid>

            ...
            <div style={{margin: 20}}>
                <GridContainer direction="column" justify="flex-start">
                    ...
                    {surgicalhistory.length === 0? (
                        <GridItem>
                            <Card>
                                <CardHeader>Patient has no reported surgeries or procedures</CardHeader>
                                <CardBody>
                                    Please use the form below to add a surgery or procedure along with any notes about it.
                                </CardBody>
                            </Card>
                        </GridItem>
                    ): (
                        <div>
                            ...
                            <div>
                                {surgicalhistory.map((surgery, index) => (
                                        <UpdateSurgicalHistoryItem surgery={surgery} />
                                ))}
                            </div>
                        </div>
                    )}
                ...
                <div className="w3-row w3-section basic-row" style={{width: '100%'}}>
                    <Autosuggest

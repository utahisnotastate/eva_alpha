...
export default function FormBuilderMenu() {
    ...
    const [forms, setForms] = React.useState([
        {label:'physical exam', path: '/edit/physicalexam', displayInNav: true},
        {label:'review of systems', path: '/edit/reviewofsystems', displayInNav: true},
        {label: 'registration', path: '/edit/registration', displayInNav: true},
        {label: 'complaint', path: '/edit/complaint', displayInNav: true},


        'review of systems', 'complaints', 'registration'
    ]);
